...
####  2.1.8. <a name='ArrayListLinkedList'></a>ArrayList 和 LinkedList 的区别是什么？
...
####  3.4.1. <a name='HashMapJDK1.8'></a>HashMap JDK1.8之前
...
###  3.7. <a name='HashMap-1'></a>HashMap的扩容操作是怎么实现的？
