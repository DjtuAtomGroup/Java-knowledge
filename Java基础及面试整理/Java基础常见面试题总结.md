<!-- vscode-markdown-toc -->
* 1. [基础概念与常识](#)
	* 1.1. [Java 语言有哪些特点?](#Java)
	* 1.2. [JVM vs JDK vs JRE](#JVMvsJDKvsJRE)
		* 1.2.1. [JVM](#JVM)
		* 1.2.2. [JDK 和 JRE](#JDKJRE)
	* 1.3. [什么是字节码?采用字节码的好处是什么?](#-1)
	* 1.4. [为什么不全部使用 AOT 呢？](#AOT)
	* 1.5. [为什么说 Java 语言“编译与解释并存”？](#Java-1)
	* 1.6. [Oracle JDK vs OpenJDK](#OracleJDKvsOpenJDK)
	* 1.7. [Java 和 C++ 的区别?](#JavaC)
* 2. [基本语法](#-1)
	* 2.1. [注释有哪几种形式？](#-1)
	* 2.2. [标识符和关键字的区别是什么？](#-1)
	* 2.3. [Java 语言关键字有哪些？](#Java-1)
	* 2.4. [自增自减运算符](#-1)
	* 2.5. [continue、break 和 return 的区别是什么？](#continuebreakreturn)
	* 2.6. [变量](#-1)
		* 2.6.1. [成员变量与局部变量的区别？](#-1)
		* 2.6.2. [静态变量有什么作用？](#-1)
		* 2.6.3. [字符型常量和字符串常量的区别?](#-1)
	* 2.7. [方法](#-1)
		* 2.7.1. [什么是方法的返回值?方法有哪几种类型？](#-1)
		* 2.7.2. [静态方法为什么不能调用非静态成员?](#-1)
		* 2.7.3. [静态方法和实例方法有何不同？](#-1)
		* 2.7.4. [重载和重写有什么区别？](#-1)
		* 2.7.5. [什么是可变长参数？](#-1)
* 3. [基本数据类型](#-1)
	* 3.1. [Java 中的几种基本数据类型了解么？](#Java-1)
	* 3.2. [基本类型和包装类型的区别？](#-1)
	* 3.3. [包装类型的缓存机制了解么？](#-1)
	* 3.4. [自动装箱与拆箱了解吗？原理是什么？](#-1)
	* 3.5. [为什么浮点数运算的时候会有精度丢失的风险？](#-1)
	* 3.6. [如何解决浮点数运算的精度丢失问题？](#-1)
	* 3.7. [超过 long 整型的数据应该如何表示？](#long)
* 4. [面向对象基础](#-1)
	* 4.1. [面向对象和面向过程的区别](#-1)
	* 4.2. [创建一个对象用什么运算符?对象实体与对象引用有何不同?](#-1)
	* 4.3. [对象的相等和引用相等的区别](#-1)
	* 4.4. [类的构造方法的作用是什么?](#-1)
	* 4.5. [如果一个类没有声明构造方法，该程序能正确执行吗?](#-1)
	* 4.6. [构造方法有哪些特点？是否可被 override?](#override)
	* 4.7. [面向对象三大特征](#-1)
		* 4.7.1. [封装](#-1)
		* 4.7.2. [继承](#-1)
		* 4.7.3. [多态](#-1)
	* 4.8. [接口和抽象类有什么共同点和区别？](#-1)
	* 4.9. [深拷贝和浅拷贝区别了解吗？什么是引用拷贝？](#-1)
* 5. [Java 常见类](#Java-1)
	* 5.1. [Object](#Object)
		* 5.1.1. [Object 类的常见方法有哪些？](#Object-1)
		* 5.1.2. [== 和 equals() 的区别](#equals)
		* 5.1.3. [hashCode() 有什么用？](#hashCode)
		* 5.1.4. [为什么要有 hashCode？](#hashCode-1)
		* 5.1.5. [为什么重写 equals() 时必须重写 hashCode() 方法？](#equalshashCode)
	* 5.2. [String](#String)
		* 5.2.1. [String、StringBuffer、StringBuilder 的区别？](#StringStringBufferStringBuilder)
		* 5.2.2. [String 为什么是不可变的?](#String-1)
		* 5.2.3. [字符串拼接用“+” 还是 StringBuilder?](#StringBuilder)
		* 5.2.4. [String#equals() 和 Object#equals() 有何区别？](#StringequalsObjectequals)
		* 5.2.5. [字符串常量池的作用了解吗？](#-1)
		* 5.2.6. [String s1 = new String("abc");这句话创建了几个字符串对象？](#Strings1newStringabc)
		* 5.2.7. [intern 方法有什么作用?](#intern)
		* 5.2.8. [String 类型的变量和常量做“+”运算时发生了什么？](#String-1)
* 6. [异常](#-1)
	* 6.1. [Exception 和 Error 有什么区别？](#ExceptionError)
	* 6.2. [Checked Exception 和 Unchecked Exception 有什么区别？](#CheckedExceptionUncheckedException)
	* 6.3. [Throwable 类常用方法有哪些？](#Throwable)
	* 6.4. [try-catch-finally 如何使用？](#try-catch-finally)
	* 6.5. [finally 中的代码一定会执行吗？](#finally)
	* 6.6. [如何使用 `try-with-resources` 代替`try-catch-finally`？](#try-with-resourcestry-catch-finally)
	* 6.7. [异常使用有哪些需要注意的地方？](#-1)
* 7. [泛型](#-1)
	* 7.1. [什么是泛型？有什么作用？](#-1)
	* 7.2. [泛型的使用方式有哪几种？](#-1)
	* 7.3. [项目中哪里用到了泛型？](#-1)
...
* 10. [SPI](#SPI)
	* 10.1. [何谓 SPI?](#SPI-1)
	* 10.2. [SPI 和 API 有什么区别？](#SPIAPI)
	* 10.3. [SPI 的优缺点？](#SPI-1)
* 11. [I/O](#IO)
	* 11.1. [什么是序列化?什么是反序列化?](#-1)
	* 11.2. [如果有些字段不想进行序列化怎么办？](#-1)
	* 11.3. [Java IO 流了解吗？](#JavaIO)
	* 11.4. [I/O 流为什么要分为字节流和字符流呢?](#IO-1)
* 12. [语法糖](#-1)
	* 12.1. [什么是语法糖？](#-1)
	* 12.2. [Java 中有哪些常见的语法糖？](#Java-1)
...
####  1.2.2. <span name='JDKJRE'></span>JDK 和 JRE
...
###  1.3. <span name='-1'></span>什么是字节码?采用字节码的好处是什么?
...
###  1.4. <span name='AOT'></span>为什么不全部使用 AOT 呢？
...
###  1.5. <span name='Java-1'></span>为什么说 Java 语言“编译与解释并存”？
...
###  1.6. <span name='OracleJDKvsOpenJDK'></span>Oracle JDK vs OpenJDK
...
###  1.7. <span name='JavaC'></span>Java 和 C++ 的区别?
...
##  2. <span name='-1'></span>基本语法

###  2.1. <span name='-1'></span>注释有哪几种形式？
...
###  2.2. <span name='-1'></span>标识符和关键字的区别是什么？
...
###  2.3. <span name='Java-1'></span>Java 语言关键字有哪些？
...
###  2.4. <span name='-1'></span>自增自减运算符

在写代码的过程中，常见的一种情况是需要某个整数类型变量增加 1 或减少 1，Java 提供了一种特殊的运算符，用于这种表达式，叫做自增运算符（++)和自减运算符（--）。

++ 和 -- 运算符可以放在变量之前，也可以放在变量之后，当运算符放在变量之前时(前缀)，先自增/减，再赋值；当运算符放在变量之后时(后缀)，先赋值，再自增/减。例如，当 `b = ++a` 时，先自增（自己增加 1），再赋值（赋值给 b）；当 `b = a++` 时，先赋值(赋值给 b)，再自增（自己增加 1）。也就是，++a 输出的是 a+1 的值，a++输出的是 a 值。用一句口诀就是：“符号在前就先加/减，符号在后就后加/减”。

###  2.5. <span name='continuebreakreturn'></span>continue、break 和 return 的区别是什么？
...
###  2.6. <span name='-1'></span>变量

####  2.6.1. <span name='-1'></span>成员变量与局部变量的区别？
...
####  2.6.2. <span name='-1'></span>静态变量有什么作用？

静态变量可以被类的所有实例共享。无论一个类创建了多少个对象，它们都共享同一份静态变量。

通常情况下，静态变量会被 `final` 关键字修饰成为常量。

####  2.6.3. <span name='-1'></span>字符型常量和字符串常量的区别?
...
###  2.7. <span name='-1'></span>方法

####  2.7.1. <span name='-1'></span>什么是方法的返回值?方法有哪几种类型？
...
####  2.7.2. <span name='-1'></span>静态方法为什么不能调用非静态成员?
...
####  2.7.3. <span name='-1'></span>静态方法和实例方法有何不同？
...
####  2.7.4. <span name='-1'></span>重载和重写有什么区别？
...
####  2.7.5. <span name='-1'></span>什么是可变长参数？
...
##  3. <span name='-1'></span>基本数据类型

###  3.1. <span name='Java-1'></span>Java 中的几种基本数据类型了解么？
...
###  3.2. <span name='-1'></span>基本类型和包装类型的区别？
...
###  3.3. <span name='-1'></span>包装类型的缓存机制了解么？
...
###  3.4. <span name='-1'></span>自动装箱与拆箱了解吗？原理是什么？
...
###  3.5. <span name='-1'></span>为什么浮点数运算的时候会有精度丢失的风险？
...
###  3.6. <span name='-1'></span>如何解决浮点数运算的精度丢失问题？
...
###  3.7. <span name='long'></span>超过 long 整型的数据应该如何表示？
...
##  4. <span name='-1'></span>面向对象基础

###  4.1. <span name='-1'></span>面向对象和面向过程的区别
...
###  4.2. <span name='-1'></span>创建一个对象用什么运算符?对象实体与对象引用有何不同?

new 运算符，new 创建对象实例（对象实例在堆内存中），对象引用指向对象实例（对象引用存放在栈内存中）。

一个对象引用可以指向 0 个或 1 个对象（一根绳子可以不系气球，也可以系一个气球）;一个对象可以有 n 个引用指向它（可以用 n 条绳子系住一个气球）。

###  4.3. <span name='-1'></span>对象的相等和引用相等的区别

- 对象的相等一般比较的是内存中存放的内容是否相等。
- 引用相等一般比较的是他们指向的内存地址是否相等。

###  4.4. <span name='-1'></span>类的构造方法的作用是什么?

构造方法是一种特殊的方法，主要作用是完成对象的初始化工作。

###  4.5. <span name='-1'></span>如果一个类没有声明构造方法，该程序能正确执行吗?
...
###  4.6. <span name='override'></span>构造方法有哪些特点？是否可被 override?
...
###  4.7. <span name='-1'></span>面向对象三大特征

####  4.7.1. <span name='-1'></span>封装
...
###  4.8. <span name='-1'></span>接口和抽象类有什么共同点和区别？
...
###  4.9. <span name='-1'></span>深拷贝和浅拷贝区别了解吗？什么是引用拷贝？
...
##  5. <span name='Java-1'></span>Java 常见类

###  5.1. <span name='Object'></span>Object

####  5.1.1. <span name='Object-1'></span>Object 类的常见方法有哪些？
...
####  5.1.2. <span name='equals'></span>== 和 equals() 的区别
...
####  5.1.3. <span name='hashCode'></span>hashCode() 有什么用？
...
####  5.1.4. <span name='hashCode-1'></span>为什么要有 hashCode？
...
####  5.1.5. <span name='equalshashCode'></span>为什么重写 equals() 时必须重写 hashCode() 方法？
...
###  5.2. <span name='String'></span>String

####  5.2.1. <span name='StringStringBufferStringBuilder'></span>String、StringBuffer、StringBuilder 的区别？
...
####  5.2.2. <span name='String-1'></span>String 为什么是不可变的?
...
####  5.2.3. <span name='StringBuilder'></span>字符串拼接用“+” 还是 StringBuilder?
...
####  5.2.4. <span name='StringequalsObjectequals'></span>String#equals() 和 Object#equals() 有何区别？

`String` 中的 `equals` 方法是被重写过的，比较的是 String 字符串的值是否相等。 `Object` 的 `equals` 方法是比较的对象的内存地址。

####  5.2.5. <span name='-1'></span>字符串常量池的作用了解吗？
...
####  5.2.6. <span name='Strings1newStringabc'></span>String s1 = new String("abc");这句话创建了几个字符串对象？
...
####  5.2.7. <span name='intern'></span>intern 方法有什么作用?
...
####  5.2.8. <span name='String-1'></span>String 类型的变量和常量做“+”运算时发生了什么？
...
###  6.1. <span name='ExceptionError'></span>Exception 和 Error 有什么区别？
...
###  6.2. <span name='CheckedExceptionUncheckedException'></span>Checked Exception 和 Unchecked Exception 有什么区别？
...
###  6.3. <span name='Throwable'></span>Throwable 类常用方法有哪些？
...
###  6.4. <span name='try-catch-finally'></span>try-catch-finally 如何使用？
...
###  6.5. <span name='finally'></span>finally 中的代码一定会执行吗？
...
###  6.6. <span name='try-with-resourcestry-catch-finally'></span>如何使用 `try-with-resources` 代替`try-catch-finally`？
...
###  6.7. <span name='-1'></span>异常使用有哪些需要注意的地方？
...
##  7. <span name='-1'></span>泛型

###  7.1. <span name='-1'></span>什么是泛型？有什么作用？
...
###  7.2. <span name='-1'></span>泛型的使用方式有哪几种？
...
###  7.3. <span name='-1'></span>项目中哪里用到了泛型？
...
##  8. <span name='-1'></span>反射

关于反射的详细解读，请看这篇文章 [Java 反射机制详解](./reflection.md) 。

###  8.1. <span name='-1'></span>何谓反射？

如果说大家研究过框架的底层原理或者咱们自己写过框架的话，一定对反射这个概念不陌生。反射之所以被称为框架的灵魂，主要是因为它赋予了我们在运行时分析类以及执行类中方法的能力。通过反射你可以获取任意一个类的所有属性和方法，你还可以调用这些方法和属性。

###  8.2. <span name='-1'></span>反射的优缺点？
...
##  9. <span name='-1'></span>注解

###  9.1. <span name='-1'></span>何谓注解？
...
###  9.2. <span name='-1'></span>注解的解析方法有哪几种？
...
##  10. <span name='SPI'></span>SPI

关于 SPI 的详细解读，请看这篇文章 [Java SPI 机制详解](./spi.md) 。

###  10.1. <span name='SPI-1'></span>何谓 SPI?
...
###  10.2. <span name='SPIAPI'></span>SPI 和 API 有什么区别？
...
###  10.3. <span name='SPI-1'></span>SPI 的优缺点？
...
##  11. <span name='IO'></span>I/O

###  11.1. <span name='-1'></span>什么是序列化?什么是反序列化?
...
###  11.2. <span name='-1'></span>如果有些字段不想进行序列化怎么办？
...
###  11.3. <span name='JavaIO'></span>Java IO 流了解吗？
...
###  11.4. <span name='IO-1'></span>I/O 流为什么要分为字节流和字符流呢?
...
##  12. <span name='-1'></span>语法糖

###  12.1. <span name='-1'></span>什么是语法糖？
...
###  12.2. <span name='Java-1'></span>Java 中有哪些常见的语法糖？
